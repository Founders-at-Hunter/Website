...
const colors = {
  50: "#F5F1E8",    // Light beige
  100: "#E8DCC4",   // Beige
  200: "#D4C4A8",   // Medium beige
  300: "#A390C0",   // Light purple
  400: "#8B5FC7",   // Medium purple
  500: "#6B46A0",   // Hunter purple
  600: "#522D80",   // Deep purple
  700: "#3D2160",   // Darker purple
  800: "#2A1740",   // Very dark purple
  900: "#1A0F28",   // Almost black purple
};
...
export function Component() {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-[#522D80] via-[#6B46A0] to-[#8B5FC7] text-[#F5F1E8] font-primary overflow-hidden relative w-full"
    >
