...
export default function Footer() {
  return (
    <footer className="md:mx-8 mx-6 space-y-6">
      ...
      <div className="w-full px-8 py-4 bg-neutral-100 rounded-md mx-auto flex items-center gap-8 justify-center">
        <Link
          href="https://www.linkedin.com/company/founders-hunter-1/"
          className="text-lg p-2 rounded-lg hover:bg-neutral-200 transition-all duration-300 ease-in-out"
          target="_blank"
        >
