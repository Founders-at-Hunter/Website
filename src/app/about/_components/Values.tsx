  ...
  return (
    <div className="md:px-8 px-6 md:py-6 py-4">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-medium mb-2">What matters to us</h1>
      ...
      <section className="grid 2xl:grid-cols-4 xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 items-stretch">
        <div
          className="rounded-2xl overflow-hidden relative md:p-8 p-6 bg-red-400 hover:scale-103 transition-all duration-300 ease-in-out space-y-2.5"
          style={{
            backgroundImage:
        ...
        >
          ...
          <h5 className="font-medium md:text-2xl text-xl mb-2 text-white">
            Collaboration
          </h5>
        ...
        <div
          className="rounded-2xl overflow-hidden relative md:p-8 p-6 bg-amber-400 hover:scale-103 transition-all duration-300 ease-in-out space-y-2.5"
          style={{
            backgroundImage:
        ...
        <div
          className="rounded-2xl overflow-hidden relative md:p-8 p-6 bg-emerald-400 hover:scale-103 transition-all duration-300 ease-in-out space-y-2.5"
          style={{
            backgroundImage:
        ...
        <div
          className="rounded-2xl overflow-hidden relative md:p-8 p-6 bg-sky-400 hover:scale-103 transition-all duration-300 ease-in-out space-y-2.5"
          style={{
            backgroundImage:
